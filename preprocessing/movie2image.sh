...
#$ -jc gpu-container_g4.168h # setting smallest possible GPU container for the test job
...
# apt-get source libgl1-mesa-dev
# cd libgl1-mesa-dev
# ./configure --prefix=~/package
# make build && make && make install
# echo 'export PATH=~/package:$PATH' >> .bash_profile
# ls -al ./
# ls -al ../
# ls -al ~/
# pwd
# ls -al ~/package/libgl1-mesa-dev
