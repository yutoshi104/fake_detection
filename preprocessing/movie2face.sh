...
#$ -jc gs-container_g1 # use hss: gtb-container_g1〜g8(A100-640GB)(max24h), gtn-container_g1〜g8(A100-320GB)(max24h), gs-container_g1(DGX2)(max24h), gtn-container_g1_dev〜g4(A100-320GB)(max4h), gs-container_g1_dev(DGX2)(max4h)
