...
#$ -jc gtn-container_g4 # use hss: gtb-container_g1〜g8(A100-640GB)(max24h), gtn-container_g1〜g8(A100-320GB)(max24h), gs-container_g1(DGX2)(max24h), gtn-container_g1_dev〜g4(A100-320GB)(max4h), gs-container_g1_dev(DGX2)(max4h)
...
#$ -e /home/toshi/fake_detection/preprocessing/logs_dfdc/movie2face.sh.e$JOB_ID
#$ -o /home/toshi/fake_detection/preprocessing/logs_dfdc/movie2face.sh.o$JOB_ID
